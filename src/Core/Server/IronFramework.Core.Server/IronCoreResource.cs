...
namespace IronFramework.Core.Server
{
    public class IronCoreResource : AsyncResource
    {
        public override void OnStart()
        {
            ...
            TextLabelController.Add(new Shared.Controllers.TextLabel("Vlad1234", new System.Numerics.Vector3(0, 0, 71)) { Scale = 0.4f } );
            TextLabelController.Add(new Shared.Controllers.TextLabel("Simple Text", new System.Numerics.Vector3(-12.519726753234863f, 5.703808307647705f, 72f), range: 5) { Scale = 0.4f });
        }
